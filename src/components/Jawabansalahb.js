    ...
    return (
        <>
            ...
            <Container fluid className="mt-4 px-4 px-lg-5">
                ...
                <Row>
                    <Col className="d-flex justify-content-center mb-3 border border-dark p-3 rounded-pill bg-success">
                        276
                    </Col>
                </Row>
                <Row>
                ...
                <Row>
                    <Col className="d-flex justify-content-center mb-3 border border-dark p-3 rounded-pill bg-danger">
                        256
                    </Col>
                </Row>
                <Row>
